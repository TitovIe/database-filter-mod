...
@Component
public class FilterFunctionArrayContainsOr extends AbstractFilterFunctionArray {
    @Override
    public Predicate toPredicate(FilterFunctionContext filterFunctionContext) {
        ...
        return criteriaBuilder.or(getPredicates(literalExpressions, positivePredicateFunction));
    }

    @Override
    public OperatorType getOperatorType() {
        return OperatorType.CONTAINS_OR;
    }
}
