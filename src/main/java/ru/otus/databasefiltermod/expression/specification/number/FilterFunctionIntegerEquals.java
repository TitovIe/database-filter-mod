...
@Component
public class FilterFunctionIntegerEquals extends AbstractFilterFunctionInteger {
    @Override
    public Predicate toPredicate(FilterFunctionContext filterFunctionContext) {
        return filterFunctionContext.getCriteriaBuilder()
                .equal(filterFunctionContext.getRoot().get(filterFunctionContext.getColumnName()),
