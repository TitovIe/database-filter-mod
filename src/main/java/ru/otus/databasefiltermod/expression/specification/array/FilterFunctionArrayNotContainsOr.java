...
@Component
public class FilterFunctionArrayNotContainsOr extends AbstractFilterFunctionArray {
    @Override
    public Predicate toPredicate(FilterFunctionContext filterFunctionContext) {
        ...
        return criteriaBuilder.or(getPredicates(literalExpressions, negativePredicateFunction));
    }

    @Override
    public OperatorType getOperatorType() {
        return OperatorType.NOT_CONTAINS_OR;
    }
}
